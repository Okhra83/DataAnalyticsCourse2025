...
- ПЗ №3: Захищений API для класифікації квітів Iris з JWT автентифікацією та rate limiting
- ПЗ №4:  Потокова обробка  даних з використанням Apache Flink та Python
